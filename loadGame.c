...
void loadGame(Game *game)
{
    ...
    // Load fonts
    game->font = TTF_OpenFont("./font/Roboto-LightItalic.ttf", 48);
    if(!game->font)
    {
    ...
    // Load Sounds
    game->dieSound = Mix_LoadWAV("./music/die.wav");
    game->landSound = Mix_LoadWAV("./music/land.wav");
    game->jumpSound = Mix_LoadWAV("./music/jump.wav");
